	...
	public class UtilityController : ControllerBase
	{
        ...
        public IActionResult jobinQueue(JobCompleted objJobCompleted)
        {
            ...
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = UtilityService.jobinQueueservice(objJobCompleted, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
        ...
        public IActionResult SuspendKoQueue(KoQueued objJobQueued)
        {
            ...
            try
            {
                ...
                header_value.lang_code = getlangCode;
                header_value.role_code = getRoleCode;
                response = UtilityService.SuspendKoQueueService(objJobQueued, header_value, constring);
                var serializedProduct = JsonConvert.SerializeObject(response, Formatting.None);
                return Ok(serializedProduct);
            }
            catch (Exception e)
