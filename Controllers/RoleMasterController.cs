...
namespace IPOApi.Controllers
{
    public class RoleMasterController : Controller
    {
        ...
        private readonly RoleMasterData objData;
        public RoleMasterController(IConfiguration configuration)
        {
            _configuration = configuration;
            objData = new RoleMasterData(_configuration);
        }
        string constring = "";
        ...
        {
            string cmus_constring = _configuration.GetSection("Appsettings")["ConnectionStrings"].ToString();
            try
            {
        ...
        public IActionResult GetUserrole_Mapping()
        {
            ...
            string cmus_constring = _configuration["Appsettings:ConnectionStrings"];
