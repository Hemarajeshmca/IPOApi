...
namespace IPOApi.Controllers
{
    public class BankmasterController : Controller
    {
        ...
        [HttpPost("getallbankmaster")]
        public IActionResult getallbankmaster([FromBody] Qcdgridread objgridread)
        {
            //int ico = 0;
            //int icount = 10 / ico;
            ...
            try
            {
                ...
                response = BankmasterService.getallbankservice (objgridread, header_value, constring);
